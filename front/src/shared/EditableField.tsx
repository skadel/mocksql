...
interface Props {
  ...
  /** Affiche un textarea plutÃ´t qu'un input */
  textarea?: boolean;
  /** Affiche un spinner pendant le chargement (l'utilisateur peut continuer Ã  taper) */
  loading?: boolean;
  /** Limite de caractÃ¨resÂ : affiche un compteur (facultatif) */
  maxLength?: number;
}
...
const EditableField: React.FC<Props> = ({
  ...
  return (
    <Box sx={{ position: "relative", width: "100%" }}>
      ...
      {/* OverlayÂ : un lÃ©ger fond + pointerEvents none */}
